...
export const ja: Messages = {
  ...
  login: {
    ...
    challengeFailed: 'ログイン用チャレンジを取得できませんでした',
    registerChallengeFailed: '登録用チャレンジを取得できませんでした',
    registerVerifyFailed: 'パスキーの登録に失敗しました',
  },
  sidebar: {
    addMenu: '追加',
    addFeed: 'フィードを追加',
  ...
  settings: {
    ...
    passkeys: {
      ...
      lastCannotDelete: '最後の1つは削除できません。先に別のパスキーを追加してください。',
      deleted: 'パスキーを削除しました',
      deleteFailed: '削除できませんでした',
      deleteTitle: 'パスキーを削除',
    ...
    sessions: {
      ...
      revoke: '失効',
      revokeConfirm: '失効する',
      revoked: 'セッションを失効しました',
      revokeFailed: '失効できませんでした',
      current: 'この端末',
      lastSeen: (datetime: string) => `最終アクセス ${datetime}`,
      revokeCurrentTitle: 'この端末のセッションを失効',
      revokeOtherTitle: 'セッションを失効',
      revokeCurrentBody:
        'この端末からログアウトします。続けるには、もう一度パスキーでログインしてください。',
      revokeOtherBody: (name: string) =>
        `「${name}」のセッションを失効します。その端末では再びログインが必要になります。`,
    },
    tokens: {
      title: 'アクセストークン',
      description:
        'Google Reader API互換のクライアントからログインするためのアクセストークンを管理できます。',
      ...
      showOnce:
        'このトークンを表示できるのは今だけです。利用するクライアントに入力してから閉じてください。',
      listTitle: 'アクセストークンの一覧',
      empty: 'アクセストークンはまだありません',
      issuedAt: (datetime: string) => `${datetime}に発行`,
      revoke: '失効',
      revokeConfirm: '失効する',
      revoked: 'アクセストークンを失効しました',
      revokeFailed: '失効できませんでした',
      revokeTitle: 'アクセストークンを失効',
      revokeBody: (name: string) =>
        `「${name}」を失効します。このアクセストークンを使っているクライアントはログインできなくなります。`,
    },
  },
  format: {
    justNow: 'たった今',
